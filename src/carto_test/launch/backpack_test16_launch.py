...
def generate_launch_description():
    ...
    urdf_file = '/home/masa/Downloads/backpack_2d_mouse.urdf'
    ...
    cartographer_node = Node(
        ...
        # arguments = ['/opt/ros/humble/share/cartographer_ros/configuration_files/backpack_2d.lua'],
        arguments = [
            '-configuration_directory','/home/masa/Downloads',
            '-configuration_basename', 'backpack_2d_mouse.lua'],
        remappings = [
